...
export { GlassInput };`;
  ...
  const usageCode = `import { GlassInput } from "@/components/ui/glass-input";
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-16 text-left">
              ...
              <h1 className="text-3xl md:text-4xl font-semibold mb-6 leading-tight">
                <span className="gradient-text">Input</span>
              </h1>
            </div>
            ...
            <div className="mb-16">
              ...
              <div className="relative overflow-hidden flex items-center justify-center w-full min-h-[200px] rounded-lg border border-border/20">
                ...
                <div className="relative z-10">
                  <GlassInput size="lg" placeholder="Enter your email" />
                </div>
              </div>
            </div>
            ...
            <div className="mb-16">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-muted-foreground mb-6">
                  The `GlassInput` component creates an elegant input
                  field with:
                </p>
            ...
            <div className="mb-16">
              <div className="max-w-4xl mx-auto">
                <p className="text-muted-foreground text-lg">
                  This implementation creates a **premium Glass input**
