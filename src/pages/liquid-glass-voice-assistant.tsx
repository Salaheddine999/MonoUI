...
export default function LiquidGlassVoiceAssistantPage() {
...
export { LiquidGlassVoiceAssistant };`;
  ...
  const usageCode = `import { LiquidGlassVoiceAssistant } from "@/components/ui/liquid-glass-voice-assistant";
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-16 text-left">
              ...
              <h1 className="text-3xl md:text-4xl font-semibold mb-6 leading-tight">
                Liquid Glass <span className="gradient-text">Voice Assistant</span>
              </h1>
            </div>
            ...
            <div className="mb-16">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-muted-foreground mb-6">
                  The `LiquidGlassVoiceAssistant` combines layered glass aesthetics with subtle motion to communicate listening and idle states:
                </p>
                <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-8">
                  <li>Layered glass shell using gradients, inner bevels, and backdrop blur for a premium frosted effect</li>
                  <li>Mic button uses a liquid-glass treatment with specular highlights and a soft ground shadow for lift</li>
                ...
                <div className="relative">
                  <div className="rounded-xl overflow-hidden border border-slate-800 shadow-2xl">
                    <div className="px-6 py-4 border-b border-slate-800 flex items-center justify-between" style={{ backgroundColor: "#282c34" }}>
                      <span className="text-slate-400 text-sm font-medium">liquid-glass-voice-assistant.tsx</span>
