...
export default function GlassWaitlistFormPage() {
...
export interface GlassWaitlistFormProps extends React.HTMLAttributes<HTMLDivElement> {
  size?: "sm" | "md" | "lg";
  placeholder?: string;
  buttonText?: string;
...
GlassWaitlistForm.displayName = "GlassWaitlistForm";`;
  ...
  const usageCode = `import { GlassWaitlistForm } from "@/components/ui/glass-waitlist-form";
          ...
          <div className="max-w-6xl mx-auto">
            <div className="mb-16 text-left">
              ...
              <h1 className="text-3xl md:text-4xl font-semibold mb-6 leading-tight">
                <span className="gradient-text">Waitlist Form</span>
              </h1>
            </div>
            ...
            <div className="mb-16">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-muted-foreground mb-6">
                  The GlassWaitlist Form combines premium glass aesthetics with smooth, accessible interactions:
                </p>
                <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-8">
                  <li>Glass container with layered gradients, inner shadows, and backdrop blur for depth</li>
                  <li>framer-motion drives success ring, glow, and shine animations on submit</li>
                  <li>Loading and success states managed via React state with timed transitions</li>
                  <li>Accessible input with icon decoration and required email validation</li>
                  <li>Configurable props: <code>size</code>, <code>placeholder</code>, <code>buttonText</code>, <code>successMessage</code>, and async <code>onSubmit</code></li>
                </ul>
              </div>
            </div>
                  ...
                  <div className="rounded-xl overflow-hidden border border-slate-800 shadow-2xl">
                    <div className="px-6 py-4 border-b border-slate-800 flex items-center justify-between" style={{ backgroundColor: "#282c34" }}>
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-slate-400 text-sm font-medium ml-4">glass-waitlist-form.tsx</span>
                      </div>
