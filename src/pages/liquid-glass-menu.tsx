...
import { LiquidGlassMenu, type LiquidGlassMenuItem } from "@/components/ui/liquid-glass-menu";
...
export default function LiquidGlassMenuPage() {
        ...
        {items.map((item) => {
          ...
          return (
            <button
              ...
              className={cn(
                "relative rounded-xl transition-colors duration-300 whitespace-nowrap flex items-center gap-2",
                itemPadding[size],
...
export { LiquidGlassMenu };`;
  ...
  const usageCode = `import { LiquidGlassMenu } from "@/components/ui/liquid-glass-menu";
...
<LiquidGlassMenu items={items} activeKey={active} onSelectItem={setActive} />`;

  const items: LiquidGlassMenuItem[] = [
    { key: "home", label: "Home", icon: <Home className="w-4 h-4" /> },
    { key: "search", label: "Search", icon: <Search className="w-4 h-4" /> },
    { key: "profile", label: "Profile", icon: <User className="w-4 h-4" /> },
    { key: "settings", label: "Settings", icon: <Settings className="w-4 h-4" /> },
  ...
  const verticalItems: LiquidGlassMenuItem[] = [
    { key: "home", label: "Home", icon: <Home className="w-4 h-4" /> },
    { key: "search", label: "Search", icon: <Search className="w-4 h-4" /> },
    { key: "profile", label: "Profile", icon: <User className="w-4 h-4" /> },
  ];
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-16 text-left">
              ...
              <h1 className="text-3xl md:text-4xl font-semibold mb-6 leading-tight">
                Liquid Glass <span className="gradient-text">Menu</span>
              </h1>
            </div>
                ...
                <div className="relative z-10 w-full max-w-4xl p-8">
                  <div className="text-center mb-8">
                    ...
                    <p className="text-white/90 text-md mb-8 leading-relaxed font-light">
                      A liquid glass menu for navigation or grouped actions with beautiful glass effects.
                    </p>
                  </div>
            ...
            <div className="mb-16">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-muted-foreground mb-6">
                  The `LiquidGlassMenu` builds a polished menu container that matches the design of other Liquid Glass components:
                </p>
            ...
            <div className="mb-16">
              <div className="max-w-4xl mx-auto">
                <p className="text-muted-foreground text-lg">
                  This implementation delivers a premium liquid glass menu for navigation and grouped actions, consistent with other components and highly customizable.
                </p>
