...
>(
  (
    ...
    const baseClasses =
      "inline-flex items-center justify-center border align-middle select-none font-sans font-semibold text-center text-white rounded-2xl backdrop-blur-lg transition-all duration-500 antialiased relative overflow-hidden";
...
export { LiquidGlassButton };`;
  ...
  const usageCode = `import { LiquidGlassButton } from "@/components/ui/liquid-glass-button";
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-16 text-left">
              ...
              <h1 className="text-3xl md:text-4xl font-semibold mb-6 leading-tight">
                Liquid Glass <span className="gradient-text">Button</span>
              </h1>
            </div>
            ...
            <div className="mb-16">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-muted-foreground mb-6">
                  The `LiquidGlassButton` component creates an interactive
                  experience where:
                </p>
                <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-8">
                  <li>
                    Sophisticated gradient backgrounds create depth and
                    dimension
                  </li>
                  <li>
                    Multiple shadow layers simulate realistic glass reflection
                  </li>
                  <li>
                    Gradient overlays provide authentic glass highlight effects
                  </li>
                  <li>Smooth hover animations enhance user interaction</li>
                  <li>Backdrop blur creates the frosted glass appearance</li>
                </ul>
              </div>
            </div>
            ...
            <div className="mb-16">
              <div className="max-w-4xl mx-auto">
                <p className="text-muted-foreground text-lg">
                  This implementation creates a **premium liquid glass button**
                  that responds to user interactions with smooth animations and
                  realistic glass effects. It's a perfect way to **enhance UI
                  interactions** in modern web applications with a
