...
export default function LiquidGlassCardPage() {
...
export { LiquidGlassCard };`;
  ...
  const usageCode = `import { LiquidGlassCard } from "@/components/ui/liquid-glass-card";
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-16 text-left">
              ...
              <h1 className="text-3xl md:text-4xl font-semibold mb-6 leading-tight">
                Liquid Glass <span className="gradient-text">Card</span>
              </h1>
            </div>
            ...
            <div className="mb-16">
              ...
              <div className="relative overflow-hidden flex items-center justify-center w-full min-h-[400px] rounded-lg border border-border/20">
                ...
                <div className="relative z-10 w-full max-w-2xl">
                  <LiquidGlassCard size="lg" variant="intense" tint="blue" className="w-full">
                  <div className="text-center mb-8">
                    ...
                    <p className="text-white/90 text-md mb-8 leading-relaxed font-light">
                      Experience the power of liquid glass design with this
            ...
            <div className="mb-16">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-muted-foreground mb-6">
                  The `LiquidGlassCard` component creates an elegant container
                  with:
                </p>
            ...
            <div className="mb-16">
              <div className="max-w-4xl mx-auto">
                <p className="text-muted-foreground text-lg">
                  This implementation creates a **premium liquid glass card**
