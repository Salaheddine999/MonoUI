...
export default function LiquidGlassButtonGroupPage() {
...
interface LiquidGlassButtonGroupProps extends React.HTMLAttributes<HTMLDivElement> {
...
const LiquidGlassButtonGroup = React.forwardRef<HTMLDivElement, LiquidGlassButtonGroupProps>(
...
LiquidGlassButtonGroup.displayName = "LiquidGlassButtonGroup";

export { LiquidGlassButtonGroup };`;

  const usageCode = `import { LiquidGlassButtonGroup } from "@/components/ui/liquid-glass-button-group";

<LiquidGlassButtonGroup orientation="horizontal" size="md">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-16 text-left">
              ...
              <h1 className="text-3xl md:text-4xl font-semibold mb-6 leading-tight">
                Liquid Glass <span className="gradient-text">Button Group</span>
              </h1>
            </div>
                ...
                <div className="relative z-10 w-full max-w-4xl p-8">
                  ...
                  <div className="space-y-12">
                    ...
                    <div className="text-center">
                      ...
                      <LiquidGlassButtonGroup orientation="vertical" size="md">
            ...
            <div className="mb-16">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-muted-foreground mb-6">
                  The `LiquidGlassButtonGroup` component creates an elegant
