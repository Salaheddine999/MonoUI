...
export default function GlassThemeTogglePage() {
...
interface GlassThemeToggleProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  size?: "sm" | "md" | "lg";
...
export const GlassThemeToggle = React.forwardRef<HTMLButtonElement, GlassThemeToggleProps>(
...
GlassThemeToggle.displayName = "GlassThemeToggle";`;

  const usageCode = `import { GlassThemeToggle } from "@/components/ui/glass-theme-toggle";

export default function Example() {
  return <GlassThemeToggle size="md" />;
}`;
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-16 text-left">
              ...
              <h1 className="text-3xl md:text-4xl font-semibold mb-6 leading-tight">
                <span className="gradient-text">Theme Toggle</span>
              </h1>
            </div>
              ...
              <div className="relative overflow-hidden w-full min-h-[220px] rounded-lg border border-border/20">
                ...
                <div className="relative z-10 flex flex-col items-center justify-center gap-6 w-full h-full p-6">
                  <div className="flex items-center gap-4">
                    <GlassThemeToggle size="lg" />
                  </div>
                  <div className="flex items-center gap-4">
                    <GlassThemeToggle size="md" />
            ...
            <div className="mb-16">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-muted-foreground mb-6">
                  The `GlassThemeToggle` provides a premium theme switcher with a sun-to-moon
                  morph-like animation and Glass styling. It features:
                </p>
            ...
            <div className="mb-16">
              <div className="max-w-4xl mx-auto">
                <p className="text-muted-foreground text-lg">
                  The GlassThemeToggle brings premium glass aesthetics to theme switching with
