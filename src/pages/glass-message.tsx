...
export default function GlassMessagePage() {
...
const GlassMessage = React.forwardRef<HTMLDivElement, GlassMessageProps>(
  ({ 
    children, 
    variant = "info", 
    size = "md", 
...
export { GlassMessage };`;
  ...
  const usageCode = `import { GlassMessage } from "@/components/ui/glass-message";

<GlassMessage variant="success" dismissible>
          ...
          <div className="max-w-6xl mx-auto">
                ...
                <div className="relative z-10 w-full max-w-4xl p-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <GlassMessage variant="success" size="md">
                        <div>
                      ...
                      <GlassMessage variant="error" size="md">
                        <div>
                      ...
                      <GlassMessage variant="warning" size="md">
                        <div>
                      ...
                      <GlassMessage variant="info" size="md">
                        <div>
            ...
            <div className="mb-16">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-muted-foreground mb-6">
                  The `GlassMessage` component creates an elegant
                  notification with:
                </p>
            ...
            <div className="mb-16">
              <div className="max-w-4xl mx-auto">
                <p className="text-muted-foreground text-lg">
                  This implementation creates a **premium Glass message**
