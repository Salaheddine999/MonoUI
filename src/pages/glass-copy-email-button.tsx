...
export default function GlassCopyEmailButtonPage() {
...
export interface GlassCopyEmailButtonProps
...
export const GlassCopyEmailButton = React.forwardRef<
  HTMLButtonElement,
  GlassCopyEmailButtonProps
...
GlassCopyEmailButton.displayName = "GlassCopyEmailButton";`;

  const usageCode = `import { GlassCopyEmailButton } from "@/components/ui/glass-copy-email-button";

export default function Example() {
  return (
    <div className="flex items-center justify-center min-h-[200px]">
      <GlassCopyEmailButton email="hello@monoui.dev" size="md" />
    </div>
  );
}`;
          ...
          <div className="max-w-6xl mx-auto">
            <div className="mb-16 text-left">
              ...
              <h1 className="text-3xl md:text-4xl font-semibold mb-6 leading-tight">
                <span className="gradient-text">Copy Email Button</span>
              </h1>
            </div>
            ...
            <div className="mb-16">
              ...
              <div className="relative overflow-hidden w-full min-h-[220px] rounded-lg border border-border/20">
                ...
                <div className="relative z-10 flex flex-col items-center justify-center gap-6 w-full h-full p-6">
                  <GlassCopyEmailButton email="support@monoui.dev" size="lg" />
                  <GlassCopyEmailButton email="hello@monoui.dev" size="md" />
                </div>
              </div>
            </div>
            ...
            <div className="mb-16">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-muted-foreground mb-6">
                  The Copy Email Button provides a premium glass effect with a smooth copy interaction:
                </p>
                  ...
                  <div className="rounded-xl overflow-hidden border border-slate-800 shadow-2xl">
                    <div className="px-6 py-4 border-b border-slate-800 flex items-center justify-between" style={{ backgroundColor: "#282c34" }}>
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-slate-400 text-sm font-medium ml-4">glass-copy-email-button.tsx</span>
                      </div>
