...
export default function GlassPromptSuggestionsPage() {
...
export { GlassPromptSuggestions };`;
  ...
  const usageCode = `import { GlassPromptSuggestions } from "@/components/ui/glass-prompt-suggestions";
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-16 text-left">
              ...
              <h1 className="text-3xl md:text-4xl font-semibold mb-6 leading-tight">
                <span className="gradient-text">Prompt Suggestions</span>
              </h1>
            </div>
            ...
            <div className="mb-16">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-muted-foreground mb-6">
                  The `GlassPromptSuggestions` component displays quick-start prompt chips or a panel list
                  with Glass aesthetics. Use it near your prompt input to help users start faster.
                </p>
            ...
            <div className="mb-16">
              <div className="max-w-4xl mx-auto">
                <p className="text-muted-foreground text-lg">
                  The GlassPromptSuggestions component provides elegant, ready-to-use prompt ideas
