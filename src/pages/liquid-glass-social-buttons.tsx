...
export default function LiquidGlassSocialButtonsPage() {
...
LiquidGlassSocialButtons.displayName = "LiquidGlassSocialButtons";`;
  ...
  const usageCode = `import { LiquidGlassSocialButtons } from "@/components/ui/liquid-glass-social-buttons";

export default function Example() {
  return (
    <LiquidGlassSocialButtons
      size="md"
      onGithub={() => {}}
      onGoogle={() => {}}
      onFacebook={() => {}}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-16 text-left">
              ...
              <h1 className="text-3xl md:text-4xl font-semibold mb-6 leading-tight">
                Liquid Glass <span className="gradient-text">Social Buttons</span>
              </h1>
            </div>
            ...
            <div className="mb-16">
              ...
              <div className="relative overflow-hidden w-full min-h-[220px] rounded-lg border border-border/20">
                ...
                <div className="relative z-10 flex flex-col items-center justify-center gap-6 w-full h-full p-6">
                  <LiquidGlassSocialButtons size="lg" />
                  <LiquidGlassSocialButtons size="md" />
                </div>
              </div>
            </div>
            ...
            <div className="mb-16">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-muted-foreground mb-6">
                  The `LiquidGlassSocialButtons` provides GitHub, Google, and Facebook sign-in buttons with
                  liquid glass styling and accessible semantics.
                </p>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-slate-400 text-sm font-medium ml-4">
                          liquid-glass-social-buttons.tsx
                        </span>
                      </div>
                      <Button
                        size="sm"
