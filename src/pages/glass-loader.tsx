...
export default function GlassLoaderPage() {
...
interface GlassLoaderProps extends React.HTMLAttributes<HTMLDivElement> {
  size?: "sm" | "md" | "lg";
...
const GlassLoader = React.forwardRef<HTMLDivElement, GlassLoaderProps>(
  (
    {
      size = "md",
      variant = "spinner",
...
export { GlassLoader };`;
  ...
  const usageCode = `import { GlassLoader } from "@/components/ui/glass-loader";

// Basic spinner
<GlassLoader variant="spinner" />
...
// Different variants
<GlassLoader variant="pulse" size="lg" />
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-16 text-left">
              ...
              <h1 className="text-3xl md:text-4xl font-semibold mb-6 leading-tight">
                <span className="gradient-text">Loader</span>
              </h1>
            </div>
            ...
            <div className="mb-16">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-muted-foreground mb-6">
                  The `GlassLoader` component provides multiple animated loading indicators with:
                </p>
                <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-8">
                  ...
                  <li>
                    Consistent Glass styling with gradient overlays
                  </li>
            ...
            <div className="mb-16">
              <div className="max-w-4xl mx-auto">
                <p className="text-muted-foreground text-lg">
                  This implementation creates **versatile loading indicators** with Glass effects
