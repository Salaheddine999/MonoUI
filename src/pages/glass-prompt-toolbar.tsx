...
export default function GlassPromptToolbarPage() {
...
export interface GlassPromptToolbarPropsProps extends React.HTMLAttributes<HTMLDivElement> {
  /**
  ...
  /**
   * Presexport interface GlassPromptToolbarProps
...
const GlassPromptToolbar = React.forwardRef<HTMLDivElement, GlassPromptToolbarProps>(
  ({ 
    model = "gpt-4",
    models = [
...
GlassPromptToolbar.displayName = "GlassPromptToolbar";

export { GlassPromptToolbar };`;

  const usageCode = `import { GlassPromptToolbar } from "@/components/ui/glass-prompt-toolbar";
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-16 text-left">
              ...
              <h1 className="text-3xl md:text-4xl font-semibold mb-6 leading-tight">
                <span className="gradient-text">Prompt Toolbar</span>
              </h1>
            </div>
            ...
            <div className="mb-16">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-muted-foreground mb-6">
                  The `GlassPromptToolbar` consolidates common prompt configuration
                  controls into a compact glass bar:
                </p>
                <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-8">
                  <li><strong>Model selector</strong>: glass button opens a glass dropdown of models.</li>
            ...
            <div className="mb-16">
              <div className="max-w-4xl mx-auto">
                <p className="text-muted-foreground text-lg">
                  The GlassPromptToolbar provides model selection, temperature control,
