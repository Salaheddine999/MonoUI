...
>(({ size = "md", className, ...props }, ref) => {
  const baseClasses =
    "bg-transparent border align-middle select-none font-sans text-white rounded-2xl backdrop-blur-md transition-all duration-500 antialiased relative overflow-hidden placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-white/30";
